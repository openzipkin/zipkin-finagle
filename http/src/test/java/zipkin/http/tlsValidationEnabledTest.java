...
public class tlsValidationEnabledTest {
  ...
  @Test public void defaultValue() {
    Option<Flag<?>> flagOption = GlobalFlag$.MODULE$.get("zipkin.http.tlsValidationEnabled");
  ...
  public void registersGlobal() {
    assertThat(globalFlags())
        .extracting(f -> f.name())
        .containsOnlyOnce("zipkin.http.tlsValidationEnabled");
  }
