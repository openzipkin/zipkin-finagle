...
public class hostTest {
  ...
  @Test public void defaultValue() {
    Option<Flag<?>> flagOption = GlobalFlag$.MODULE$.get("zipkin.scribe.host");
    assertThat(flagOption.get().apply()).isEqualTo("localhost:1463");
  }
  ...
  public void registersGlobal() {
    assertThat(globalFlags())
        .extracting(f -> f.name())
        .containsOnlyOnce("zipkin.scribe.host");
  }
